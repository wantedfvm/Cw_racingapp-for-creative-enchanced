...
-- Keybind disabled - ox_lib not available
-- lib.addKeybind({
...
-- Alternative keybind using RegisterKeyMapping
RegisterKeyMapping('show_performance', 'Hold to Show Vehicle Class and PI', 'keyboard', 'LMENU')
RegisterCommand('+show_performance', function()
    if not Config.DrawTextAuthFunc() then return end
    displayActive = true
    showPerformanceIndex()
end, false)
